...
public class MotherBoardWithoutWiFiBuilder : IMotherBoardWithoutWiFiBuilder
{
    ...
    private IWiFiAdapter? ConnectedWiFiAdapter { get; set; }
    ...
    public IMotherBoardBuilder SetWiFi(IWiFiAdapter? wiFiAdapter)
    {
    ...
    {
        return new MotherBoardWithoutWiFi(
